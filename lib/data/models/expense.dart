class Expense {
  ...
  double get balance {
    if (paidByUser > 0 && paidByFriend == 0) {
      ...
      return (paidByUser - shouldBePaidByUser) + (paidByFriend - shouldBePaidByFriend);
    } else {
